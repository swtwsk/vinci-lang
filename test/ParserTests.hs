...
structTests = testGroup "Struct"
    ...
    where
        ...
        returnLine = "let proc glPos -> VertOuts = VertOuts { gl_Position = glPos };;"
        returnAbsLine = Abs.Prog Nothing [Abs.Value Nothing (Abs.Let Nothing [Abs.ProcBind Nothing (Abs.ProcNameId Nothing (Abs.VIdent "proc")) [Abs.LetLVI Nothing (Abs.LambdaVId Nothing (Abs.VIdent "glPos"))] (Abs.RetType Nothing (Abs.TStruct Nothing (Abs.SIdent "VertOuts"))) (Abs.ECons Nothing (Abs.SIdent "VertOuts") [Abs.FieldDef Nothing (Abs.VIdent "gl_Position") (Abs.EId Nothing (Abs.VIdent "glPos"))])])]
        returnASTLine = Prog [Value (Let [ProcBind "proc" [LambdaVId "glPos"] (Just (TStruct "VertOuts")) (ECons "VertOuts" [FieldDef "gl_Position" (EId "glPos")])])]
