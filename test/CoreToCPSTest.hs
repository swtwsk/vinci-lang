...
tests = testGroup "CoreToCPS tests" 
    ...
    where
        ...
        cpsFib  = CPS.CProcLam "fib" [] $ CPS.CLetVal "f" (CPS.CLamCont "k" "n" (CPS.CLetFix "help" "k2" "a" (CPS.CLetVal "f2" (CPS.CLamCont "k6" "b" $ CPS.CLetVal "f3" (CPS.CLamCont "k7" "n" $ CPS.CLetVal "x00" (CPS.CLitFloat 0.0) (CPS.CLetPrim "r1" (CPS.CBinOp Core.OpLT) ["x00", "n"] (CPS.CLetCont "k81" "x81" (CPS.CLetCont "k11" "x11" (CPS.CLetPrim "r3" (CPS.CBinOp Core.OpAdd) ["a", "b"] (CPS.CLetCont "k10" "x10" (CPS.CLetVal "x91" (CPS.CLitFloat 1.0) (CPS.CLetPrim "r2" (CPS.CBinOp Core.OpSub) ["n", "x91"] (CPS.CAppFun "x10" "k7" "r2"))) (CPS.CAppFun "x11" "k10" "r3"))) (CPS.CAppFun "help" "k11" "b")) (CPS.CLetCont "k82" "x82" (CPS.CAppCont "k7" "a") (CPS.CIf "r1" "k81" "k82"))))) (CPS.CAppCont "k6" "f3")) (CPS.CAppCont "k2" "f2")) (CPS.CLetVal "x0" (CPS.CLitFloat 0.0) (CPS.CLetCont "k5" "z" (CPS.CLetVal "x1" (CPS.CLitFloat 1.0) (CPS.CLetCont "k4" "y" (CPS.CAppFun "y" "k" "n") (CPS.CAppFun "z" "k4" "x1"))) (CPS.CAppFun "help" "k5" "x0"))))) (CPS.CExit "f")
