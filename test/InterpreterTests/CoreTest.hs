...
tests = testGroup "Core tests"
    ...
    where
        constLambda = LetFun (Prog "f" ["x"] (Lit $ LFloat 1.0)) (App (Var "f") (Lit $ LFloat 2.0))
        tuple = Let "x" (TupleCons [Lit $ LFloat 1.0, Lit $ LFloat 2.0]) (TupleProj 0 (Var "x"))
        fibProg = Prog "fib" ["n"] (LetFun (Prog "help" ["a", "b", "n"] (If (BinOp OpLT (Lit $ LFloat 0.0) (Var "n")) (App (App (App (Var "help") (Var "b")) (BinOp OpAdd (Var "a") (Var "b"))) (BinOp OpSub (Var "n") (Lit $ LFloat 1.0))) (Var "a"))) (App (App (App (Var "help") (Lit $ LFloat 0.0)) (Lit $ LFloat 1.0)) (Var "n")))
